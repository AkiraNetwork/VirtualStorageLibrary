...
namespace AkiraNetwork.VirtualStorageLibrary.Test
{
    ...
    {
        private List<NotifyNodeInfo> _notifyNodeInformation = [];

        private List<ActionNodeInfo> _actionNodeInformation = [];
        ...
        public void ChangeDirectory_WithNonExistentDirectory_ThrowsDirectoryNotFoundException()
        {
            ...
            // Act and Assert
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.ChangeDirectory(nonExistentDirectory));
        }
        ...
        public void AddDirectory_InvalidPath_ThrowsException()
        {
            ...
            // Act & Assert
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.AddDirectory(invalidPath, newDirectory));
        }
        ...
        public void GetNode_ThrowsVirtualNodeNotFoundException_WhenDirectoryDoesNotExist()
        {
            ...
            // メソッドを実行し、例外を検証
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.GetNode("/NonExistentDirectory"));
        }
        ...
        public void GetNode_ThrowsWhenSymbolicLinkIsBroken()
        {
            ...
            // Act & Assert
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.GetNode("/brokenLink", true));
        }
        ...
        public void GetDirectory_WhenDirectoryDoesNotExist_ThrowsVirtualNodeNotFoundException()
        {
            ...
            // Act and Assert
            Exception err = Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.GetDirectory(path));

            Assert.AreEqual("Path not found. [/nonexistent]", err.Message);
        ...
        public void GetDirectory_WhenNodeIsNotDirectory_ThrowsVirtualNodeNotFoundException()
        {
            ...
            // Act and Assert
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.GetDirectory(path));
        }
        ...
        public void GetItem_WhenItemDoesNotExist_ThrowsVirtualNodeNotFoundException()
        {
            ...
            // Act and Assert
            Exception err = Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.GetItem(path));
        ...
        public void GetItem_WhenNodeIsNotItemType_ThrowsVirtualNodeNotFoundException()
        {
            ...
            // Act and Assert
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.GetItem(path));
        }
        ...
        public void GetSymbolicLink_WhenLinkDoesNotExist_ThrowsVirtualNodeNotFoundException()
        {
            ...
            // Act and Assert
            Exception err = Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.GetSymbolicLink(path));

            Assert.AreEqual("Path not found. [/nonexistent-link]", err.Message);
        ...
        public void GetSymbolicLink_WhenNodeIsNotLink_ThrowsVirtualNodeNotFoundException()
        {
            ...
            // Act and Assert
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.GetSymbolicLink(path));
        }
        ...
        public void AddItem_ThrowsVirtualNodeNotFoundException_WhenParentDirectoryDoesNotExist_WithBinaryData()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.AddItem(path, item));
        }
        ...
        public void AddItem_ToNonExistingDirectory_ShouldThrowVirtualNodeNotFoundException()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.AddItem(directoryPath, item, false));
        }
        ...
        public void AddItem_ToLocationPointedBySymbolicLink_ShouldThrowException()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.AddItem(linkPath, item, false));
        }
        ...
        [TestMethod]
        [TestCategory("GetPaths")]
        public void GetPaths_WithPaths_ValidTest()
        {
            VirtualStorage<BinaryData> vs = new();

            SetTestData(vs);

            Assert.AreEqual(23, vs.GetPaths(VirtualPath.Root, VirtualNodeTypeFilter.All, true).Count());
            Debug.WriteLine("\nAll nodeContexts:");
            foreach (VirtualPath name in vs.GetPaths(VirtualPath.Root, VirtualNodeTypeFilter.All, true))
            {
                Assert.IsNotNull(name);
                Debug.WriteLine(name);
            }

            Assert.AreEqual(7, vs.GetPaths(VirtualPath.Root, VirtualNodeTypeFilter.Directory, true).Count());
            Debug.WriteLine("\nDirectories:");
            foreach (VirtualPath name in vs.GetPaths(VirtualPath.Root, VirtualNodeTypeFilter.Directory, true))
            {
                Assert.IsNotNull(name);
                Debug.WriteLine(name);
            }

            Assert.AreEqual(14, vs.GetPaths(VirtualPath.Root, VirtualNodeTypeFilter.Item, true).Count());
            Debug.WriteLine("\nItems:");
            foreach (VirtualPath name in vs.GetPaths(VirtualPath.Root, VirtualNodeTypeFilter.Item, true))
            {
                Assert.IsNotNull(name);
                Debug.WriteLine(name);
            }

            Assert.AreEqual(2, vs.GetPaths(VirtualPath.Root, VirtualNodeTypeFilter.SymbolicLink, true).Count());
            Debug.WriteLine("\nSymbolicLink:");
            foreach (VirtualPath name in vs.GetPaths(VirtualPath.Root, VirtualNodeTypeFilter.SymbolicLink, true))
            {
                Assert.IsNotNull(name);
                Debug.WriteLine(name);
            }
            ...
            vs.ChangeDirectory("/Directory1");
            Assert.AreEqual(3, vs.GetPaths(VirtualNodeTypeFilter.Directory, false).Count());
            Debug.WriteLine("\nDirectories in /Directory1:");
            foreach (VirtualPath name in vs.GetPaths(VirtualNodeTypeFilter.Directory, false))
            {
                Assert.IsNotNull(name);
                Debug.WriteLine(name);
            }
            ...
            vs.ChangeDirectory("/Directory1");
            Assert.AreEqual(2, vs.GetPaths(VirtualNodeTypeFilter.Item, false).Count());
            Debug.WriteLine("\nItems in /Directory1:");
            foreach (VirtualPath name in vs.GetPaths(VirtualNodeTypeFilter.Item, false))
            {
                Assert.IsNotNull(name);
                Debug.WriteLine(name);
            }
        ...
        public void RemoveNode_NonExistingItem_ThrowsException()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.RemoveNode("/NonExistingItem"));
        }
        ...
        public void SetNodeName_ThrowsWhenNodeDoesNotExist()
        {
            ...
            Assert.IsTrue(vs.GetNode("/").CreatedDate == vs.GetNode("/").UpdatedDate);
            Assert.AreEqual("Path not found. [/nonExistentFile]", err.Message);
        ...
        public void MoveNode_ThrowsWhenNodeDoesNotExist()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.MoveNode("/nonExistentItem", "/newName"));
        ...
        public void MoveDirectoryInternal_ThrowsExceptionWhenParentDirectoryDoesNotExist()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.MoveNode("/sourceDir", "/nonExistentDir/newDir"));
        ...
        public void AddSymbolicLink_ToNonExistingDirectory_ShouldThrowVirtualNodeNotFoundException()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.AddSymbolicLink(directoryPath, link, false));
        }
        ...
        public void AddSymbolicLink_ToLocationPointedBySymbolicLink_ShouldThrowException()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.AddSymbolicLink(linkPath, link, false));
        }
        ...
        public void WalkPathToTarget_NonExistentPathWithExceptionEnabled()
        {
            ...
            Exception exception = Assert.ThrowsException<VirtualPathNotFoundException>(() =>
            {
                VirtualNodeContext? nodeContext = vs.WalkPathToTarget(targetPath, NotifyNode, null, true, true);
            });
        ...
        public void WalkPathToTarget_SymbolicLinkToLink()
        {
            ...
            Debug.WriteLine(_notifyNodeInformation.GenerateTableDebugText());
        ...
        public void WalkPathToTarget_NonExistentPathAndCreatePath()
        {
            ...
            Debug.WriteLine(_actionNodeInformation.GenerateTableDebugText());
        ...
        private void NotifyNode(VirtualPath path, VirtualNode? node)
        {
            ...
            _notifyNodeInformation.Add(new NotifyNodeInfo(path, node));
        }
        ...
        private bool ActionNode(VirtualDirectory parentDirectory, VirtualNodeName nodeName, VirtualPath nodePath)
        {
            ...
            _actionNodeInformation.Add(new ActionNodeInfo(parentDirectory, nodeName, nodePath));
        ...
        public void ExpandPath_WithInvalidDirectoryPath_ThrowsVirtualNodeNotFoundException()
        {
            ...
            Assert.ThrowsException<VirtualPathNotFoundException>(() => vs.ExpandPath("/invalid/dir/*.txt").ToList());
        }
        ...
        public void ExpandPath_DeepDirectoryStructureTest()
        {
            ...
            // ツリー構造の表示
            Debug.WriteLine("Virtual vs tree structure:");
            string tree = vs.GenerateTreeDebugText(BaseDir, true, true);
            Debug.WriteLine(tree);
        ...
        public void Locale_Test1()
        {
            ...
            // Assert
            Assert.AreEqual("Path not found. [/nonexistent]", exception.Message);
        }
        ...
        public void Locale_Test3()
        {
            ...
            // Assert
            Assert.AreEqual("パスが見つかりません。 [/nonexistent]", exception.Message);
        }
        ...
        public void Indexer_Test8()
        {
            // Arrange
            VirtualStorage<BinaryData> vs = new();
            VirtualItem<BinaryData> item1 = new("item1");
            ...
            Assert.AreEqual("item1", (string)vs.GetItem("/link1", true).Name);
        ...
        public void Indexer_Test9()
        {
            ...
            VirtualStorage<BinaryData> vs = new();
            VirtualItem<BinaryData> item1 = new("item1");
            VirtualItem<BinaryData> item2 = new("item2");
            VirtualSymbolicLink link1 = new("link1", "/item1");
            VirtualSymbolicLink newLink1 = new("link1", "/item2");
            ...
            // Assert
            Assert.AreEqual("link1", (string)vs.GetSymbolicLink("/link1").Name);
            Assert.AreEqual("/item2", (string)vs.GetSymbolicLink("/link1").TargetPath);
            Assert.AreEqual("item2", (string)vs.GetItem("/link1", true).Name);
            Assert.AreEqual(VirtualNodeType.Item, vs.GetSymbolicLink("/link1").TargetNodeType);
        }
